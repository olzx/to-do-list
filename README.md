...
В папке js файл app.js - отвечает за удаление, редактирование, добавление новых задач. В первых версиях этого файла закомментировано более 90% кода, это может помочь разобраться в работе (что за что отвечает).
## Задачи на будущее
- Сделать адаптивность;
- <s>Добавить оповещение/индикацию об ошибках (не вставлен текст, успешное сохранение и др.);
- Добавить dragDrop;
